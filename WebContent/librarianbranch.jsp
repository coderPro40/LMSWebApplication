...
<%
	...
	String[] branchColumns = { "Name", "Address", "Update" };
...
<div class="container">
	<div class="row">
		<div class="col-lg-12 text-center">
			<h4 class="service-heading">List of all Library Branch</h4>
			<p id="demo"></p>
		</div>
	</div>
	<br>
	<div class="row">
		...
		<div class="col-lg-6 text-right" style="display:inline;">
			<button
				onclick="window.location='librariannoofcopies.jsp#addBranches'"
				type="button" class="btn btn-secondary">Add Copies to Branch</button>
		</div>
	</div>
		...
		<div class="col-md-12">
			<table class="table table-striped">
				...
				<tr>
					...
					<td><button
							onclick="window.location='updatebranchto.jsp?branchId=<%=b.getBranchId()%>'"
							type="button" class="btn btn-success">Update</button></td>
				</tr>
				<%
					count++;
					}
